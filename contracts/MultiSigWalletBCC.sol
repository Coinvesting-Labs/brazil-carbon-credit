...
import "./BrazilCarbonCredit.sol";
import "@openzeppelin/contracts/access/Ownable.sol";

contract MultiSigWalletBCC is Ownable{
    // Types
    enum Authorization {
        NONE,
        OWNER,
    ...
    // Public variables
    BrazilCarbonCredit public tokenContract;
    ...
    function setTokenContract(BrazilCarbonCredit _tokenContract) external onlyOwner canContractSet {
